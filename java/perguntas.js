export const perguntas = [
    {
        enunciado: "O uso abusivo de substâncias lícitas e ilícitas tem um impacto social profundo que vai além da saúde individual, desestabilizando famílias e comunidades, e resultando em baixa coesão social e aumento da violência. O principal desafio é a **falta de estratégias comunitárias** que promovam a prevenção eficaz e a reintegração social. Qual abordagem inicial você priorizaria para fortalecer a resiliência comunitária contra esse problema?",
        alternativas: [
            {
                texto: "Fortalecer o acesso universal a serviços de saúde mental e tratamento especializado para dependentes químicos.",
                afirmacao: [
    ...
    {
        enunciado: "Considerando a complexidade do problema, muitas empresas estão adotando a **Responsabilidade Social Corporativa (RSC)** para mitigar o impacto do uso de drogas no ambiente de trabalho e nas comunidades vizinhas. Qual deve ser o foco da RSC para a **Sustentabilidade Social** nesta área?",
        alternativas: [
            {
                texto: "Concentrar esforços em doações para clínicas de reabilitação e campanhas de conscientização genéricas em mídia de massa.",
                afirmacao: [
    ...
    {
        enunciado: "Em uma comunidade onde o tráfico de drogas desestrutura as relações e impõe a Lei do silêncio, qual ação, focada em **empoderamento social**, seria a mais eficaz para reconstruir a confiança e a capacidade de autogestão?",
        alternativas: [
            {
                texto: "Aumentar a presença policial e a fiscalização ostensiva para reprimir o tráfico e o consumo em locais públicos.",
                afirmacao: [
    ...
    {
        enunciado: "Na abordagem de **Redução de Danos (RD)**, um princípio fundamental para a Sustentabilidade Social é o reconhecimento da **dignidade humana** e a minimização de riscos. Qual ação exemplifica melhor o conceito de RD em um contexto comunitário?",
        alternativas: [
            {
                texto: "Exigir a abstinência imediata como única condição para fornecer qualquer tipo de suporte ou auxílio social/médico.",
                afirmacao: [
    ...
    {
        enunciado: "O estigma e o preconceito contra usuários de drogas e seus familiares são grandes barreiras para a reintegração social. Qual tipo de intervenção, focada na **transformação cultural** dentro da comunidade, seria mais eficaz para combater o estigma?",
        alternativas: [
            {
                texto: "Realizar palestras isoladas em escolas sobre os malefícios das drogas, focando no medo e na punição.",
                afirmacao: [
